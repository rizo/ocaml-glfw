...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3e5f8293fa7357285d44e42bd39f443c) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lglfw3"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "glfw";
                           FindlibPackage ("tgls.tgl4", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "camlp4o"; ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {exec_custom = false; exec_main_is = "test_glfw.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/rizo/ocaml-glfw.git";
                      src_repo_browser =
                        Some "https://github.com/rizo/ocaml-glfw";
     ...
     oasis_digest = Some "\0044\178\225_\185\197su\193L[\020\252n\208";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
